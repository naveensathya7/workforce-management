...
public class EmployeeController {
  ...
  /**
   * @Valid — triggers Bean Validation on the incoming @RequestBody. If any @NotBlank / @Email
   * / @Pattern constraint fails, Spring throws MethodArgumentNotValidException, which our
  ...
  public ResponseEntity<String> updateEmployee(
      @PathVariable Long employeeId, @Valid @RequestBody EmployeeDTO dto) {
